...
git subtree pull --prefix=public \
	git@github.com:significantstats/significantstats.github.io.git master -m "Merge origin master"
...
git subtree push --prefix public git@github.com:significantstats/significantstats.github.io.git master